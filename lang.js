...
(function initMissionAnimation() {
  ...
  function drawVignette() {
    ...
    grad.addColorStop(0, 'rgba(126,150,92,0.5)');
    grad.addColorStop(0.35, 'rgba(126,150,92,0.28)');
    grad.addColorStop(0.7, 'rgba(126,150,92,0.05)');
    grad.addColorStop(1, 'rgba(126,150,92,0.0)');
    ctx.fillStyle = grad;
